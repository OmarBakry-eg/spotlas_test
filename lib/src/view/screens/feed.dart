...
class FeedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) => _bloc.fetchAllFeed());
    return Scaffold(
      appBar: AppBar(
        ...
        builder: (context, state) {
          return _bloc.loading
              ...
              : _bloc.err
                  ...
                  : ListView.separated(shrinkWrap: true,itemBuilder:(c,i)=>  FeedContent(
                    feedModel: FeedController.feedModel[i],
                  ),itemCount: FeedController.feedModel.length,separatorBuilder: (c,i)=> const SizedBox(height: 20,),);
        },
      ),
    );
  }
